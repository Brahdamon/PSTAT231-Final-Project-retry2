---
title: "Deep_Solar_Dataset_Statistical_Machine_Learning"
...
Out of all of the models fitted, the random forest model was the most accurate predictor of the number of Photovoltaic systems installed in a census tract on the test data, with a rmse value of 27.5 and an $R^2$ value of 0.755. 

Because this dataset contained so many predictors, it would be interesting to perform a more thorough analysis  of the relationships between the predictors and the response variable. The variables included in this analysis were chosen from the set of all variables by intuitive evaluation of whether the value of the predictor would have a significant effect on the response. Likely, some important variables were overlooked, and some insignificant variables were included. 
